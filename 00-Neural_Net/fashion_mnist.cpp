...
const std::string& MNIST_TRAIN_DATA_PATH = "./dataset/FASHION_MNIST/fashion-mnist_train.csv";
const std::string& MNIST_NETWORK_SAVE_PATH = "./dataset/FASHION_MNIST/NNs/fashion_mnist";
