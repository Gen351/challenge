...
// --- CONFIGURATION ---
const std::string csvPath = "cnn-data/flowers/flowers_dataset.csv"; // Make sure path matches your folder structure
const std::string saveNameBase = "FlowerAmpota_RGB";

// Set this to "" to train from scratch, or "FlowerAmpota_RGB0" to resume
const std::string loadModelName = ""; 

// Image Settings
const int IMG_SIZE = 64; 
const int CHANNELS = 3; 
const int CLASSES = 5; // Daisy, Dandelion, Rose, Sunflower, Tulip
// ---------------------
...
int main(int argc, char* argv[]) {
    ...
    // 1. Load Data
    std::cout << "--- Loading Flower Dataset ---" << std::endl;
